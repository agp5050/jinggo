...
package ml.jinggo.data.repository;
...
//        dropTable();
    ...
    public void insertData() throws SQLException {
        for (int i = 1; i < 10; i++) {
            ...
            long orderId2 = executeAndGetGeneratedKey(dataSource, "INSERT INTO t_order (user_id, status) VALUES (11, 'INIT')");
            execute(dataSource, String.format("INSERT INTO t_order_item (order_id, user_id) VALUES (%d, 11)", orderId2));
        }
    }
    ...
    //    String sql = "SELECT i.* FROM t_order o JOIN t_order_item i ON o.order_id=i.order_id WHERE o.user_id=?";
        String sql = "SELECT i.* FROM t_order_item i WHERE i.user_id=?";
        try (
