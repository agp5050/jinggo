...
public class UserJdbcWithoutTransManagerService {
    ...
    public static void main(String[] args) {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("jdbc/jdbcWithoutTx.xml");
        ...
        //插入一条记录，初始分数为10
        jdbcTemplate.execute("INSERT INTO t_user(user_name,password,score,last_logon_time) VALUES('mark','123456',10,"+System.currentTimeMillis()+")");
